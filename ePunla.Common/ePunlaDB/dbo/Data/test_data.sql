...
INSERT INTO @Users
SELECT 1, 'agricultureepunla@gmail.com','April Joyce','Natanauan',@pHash , @pSalt
UNION SELECT 2,'johnkennethfurog@gmail.com','John Kenneth','Furog',@pHash , @pSalt
...
WHEN NOT MATCHED 
    THEN INSERT (UserId,Email, FirstName,LastName,PasswordHash,PasswordSalt) 
    VALUES ([SOURCE].UserId,[SOURCE].Email,[SOURCE].FirstName,[SOURCE].LastName,[SOURCE].PasswordHash,[SOURCE].PasswordSalt);
