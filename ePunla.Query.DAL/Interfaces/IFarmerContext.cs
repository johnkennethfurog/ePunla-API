...
namespace ePunla.Query.DAL.Interfaces
{
    public interface IFarmerContext
    {
        ...
        Task<ContextResponse<IEnumerable<FarmerFarmModel>>> GetFarms(int FarmerId, string Status);
        ...
        Task<ContextResponse<IEnumerable<FarmerDashboardModel>>> GetDashboard();
    }
}
